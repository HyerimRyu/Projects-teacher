package com.mrhi2018.ex77bluetoothchattest;
...
public class ServerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bluetoothAdapter==null){
            ...
            finish();//바로 종료되지 않기에..여기서 멈추고 싶다면
            return;
        }
        ...
        switch (requestCode){
            case REQ_ENABLE:
                if(resultCode==RESULT_CANCELED){
                    //Enable은 거부하였으면..앱 사용못함
                    Toast.makeText(this, "블루투수를 허용하지 않았습니다.\n앱을 종료합니다.", Toast.LENGTH_SHORT).show();
                    finish();
                }else{
                    //서버소켓 생성 작업 실행
                    createServerSocket();
    ...
    void createServerSocket(){
        ...
        //탐색할 수 있도록 허용해야만 함.
        //[허용]선택하는 화면 액티비티를 실행하기(다이얼로그 처럼 화면이 보여짐)
        //기본 탐색 허용시간이 120초임.
    ...
    //////////////////////////////////////////////
    //서버소켓작업 스레드클래스 정의 : inner class의 위치
