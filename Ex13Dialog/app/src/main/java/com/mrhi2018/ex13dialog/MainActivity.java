package com.mrhi2018.ex13dialog;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void clickBtn(View view) {
        ...
        //건축가에게 다이얼로그객체를 만들어 달라고 요청!!
        AlertDialog dialog= builder.create();

        //다이얼로그의 바깥쪽을 터치했을때 기본은 취소됨.
        //취소되지 않도록 설정할 수 있음.
        //dialog.setCancelable(false);//뒤로가기 버튼도 취소불가능
    ...
    public void clickBtn3(View view) {
        ...
        // 두번째 파라미터 : 다이얼로그가 보일때 처음 선택된 RadioButton의 인덱스번호(1- 두번째 아이템)
    ...
    public void clickBtn5(View view) {
        ...
        //res폴더안에 layout폴더안에 있는 dialog.xml를
        //뷰 객체로 생성(부풀리다)시켜주는 객체를
        //운영체제대리인(Context)으로 부터 얻어오기
        LayoutInflater inflater= getLayoutInflater();
        View layout= inflater.inflate(R.layout.dialog, null);

        //만들어진 layout(LinearLayout객체)에게
