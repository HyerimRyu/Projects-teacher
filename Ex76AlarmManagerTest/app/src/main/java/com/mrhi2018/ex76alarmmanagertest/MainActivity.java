package com.mrhi2018.ex76alarmmanagertest;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void clickBtn(View view) {
        ...
        //알람이 울릴때 실행할 Intent를 PendingIntent로 생성
        ...
        //백그라운드에 오래 있으면(1~2시간) 자동 프로세스가 죽어버림.
        //심지어 알람매니저도 같은 잠자버림....
    ...
    public void clickBtn2(View view) {
        //반복 알람설정
        //setRepeating().. api19(kitket)부터 이 메소드가 없어졌음.
        //반복 알람설정이 기능이 없어졌기에 이를 구현하려면..
        //알람 설정 후 알람시에 다시 새로운 알람을 예약하는 방식을 사용
    ...
    public void clickBtn4(View view) {
        ...
        Month= calendar.get(Calendar.MONTH);//1월->0
    ...
    DatePickerDialog.OnDateSetListener onDateSetListener= new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
            ...
            TimePickerDialog dialog= new TimePickerDialog(MainActivity.this, timeSetListener, Hour, Min, true);
            dialog.show();
        }
    };
