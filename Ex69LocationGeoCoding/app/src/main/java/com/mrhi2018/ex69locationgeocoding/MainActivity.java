package com.mrhi2018.ex69locationgeocoding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //지오코딩을 하려면 구글서버에서 데이터를 읽어오므로..
        //인터넷 퍼미션이 요구됨.
        //구글플레이스토어 앱이 디바이스에 없으면 안됨.
    }
    ...
    public void clickShowMap(View view) {
        //구글지도앱(or 네이버맵, 카카오맵 등..)을 통해 지도 표시
        ...
        //구글지도는 기본 마커가 없음[카카오맵, 네이버맵은 마커가 기본 있음]
        uri= Uri.parse("geo:"+latitude+","+longitude+"?q="+latitude+","+longitude+"(" + address + ")");
