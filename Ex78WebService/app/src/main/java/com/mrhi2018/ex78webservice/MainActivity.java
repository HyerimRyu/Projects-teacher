package com.mrhi2018.ex78webservice;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void clickBtn(View view) {
        ...
        new Thread(){
            ...
            public void run() {
                //서버에 있는 텍스트파일의 경로
                String serverAddress= "http://mrhi2019.dothome.co.kr/index.html?";
                ...
                try {
                    ...
                    String line=null;
                    line= reader.readLine(); //첫번째 한줄씩 읽기!!
                    while(true){
    ...
    public void clickBtn2(View view) {
        //서버에 있는 이미지파일 읽어오기
        String serverAddress= "http://mrhi2019.dothome.co.kr/Penguins.jpg";
